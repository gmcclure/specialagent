...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.linkbox_top'
        db.add_column('precis_page', 'linkbox_top', self.gf('django.db.models.fields.CharField')(default=30, max_length=40), keep_default=False)

        # Adding field 'Page.linkbox_left'
        db.add_column('precis_page', 'linkbox_left', self.gf('django.db.models.fields.CharField')(default=18, max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.linkbox_top'
        db.delete_column('precis_page', 'linkbox_top')

        # Deleting field 'Page.linkbox_left'
        db.delete_column('precis_page', 'linkbox_left')
    ...
    models = {
        ...
        'precis.page': {
            ...
            'linkbox_left': ('django.db.models.fields.CharField', [], {'default': '18', 'max_length': '40'}),
