...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.linkbox_enabled'
        db.add_column('precis_page', 'linkbox_enabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Page.linkbox_left'
        db.alter_column('precis_page', 'linkbox_left', self.gf('django.db.models.fields.CharField')(max_length=400))


    def backwards(self, orm):
        
        # Deleting field 'Page.linkbox_enabled'
        db.delete_column('precis_page', 'linkbox_enabled')

        # Changing field 'Page.linkbox_left'
        db.alter_column('precis_page', 'linkbox_left', self.gf('django.db.models.fields.CharField')(max_length=40))
