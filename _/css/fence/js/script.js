...
/* PROGRESS BAR SECTION START
	...
	*/
    ...
    var progress = function () {
        ...
        el.css('background-color', '#65CC57');
	...
	*/
    ...
    var email = function () {
        ...
        function submitEmail(evt) {
            ...
            $.post('/invite/store_email/', $('#emailform').serialize(), function() {
                $('#id_email').val('').blur();
                $('#invitation_feedback').text('Thank you for your interest! We will be in touch soon!');
            });
        ...
        function check() {
            ...
            if (verify(email)) {
                //valid email 
                button.css('background-color','#65CC57');
